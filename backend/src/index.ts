    ...
    const ROLES = [
      {
        ...
        permissions: [
          ...
          "api::farm-parcel.farm-parcel.idleAtRisk",
          "api::farm-parcel.farm-parcel.recommendations",
          ...
          "api::farmer.farmer.findDeep",
          "api::farmer.farmer.findOneDeep",
          "api::farmer.farmer.search",
          ...
          "api::farm.farm.count",
          "api::farm.farm.findWithSummary",
          "api::farm.farm.findOneWithSummary",
